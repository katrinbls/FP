...
Der Zusammenhang zwischen dem Rotationswinkel $\theta_{\symup{frei}}$ und der Wellenlänge $\lambda$ ist gemäß Formel \ref{eq:}
...
\end{align}
ergibt. Zur Berechnung der effektiven Masse wird für den Brechungsindex der Literaturwert $n=3,57$ \cite[Quelle1] verwendet. Somit ergibt sich für die effektive Masse die beiden Werte
\begin{align*}
    m_1^{*} &= (0,02889 \pm 0.0001)\cdot m_e \\
    m_2^{*} &= (0.08516 \pm 0.0017)\cdot m_e \qquad .
\end{align*}
