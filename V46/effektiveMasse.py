...
plt.plot(lam**2, theta_undot, 'bx' , label= 'Messwerte', linewidth = 1)
plt.xlabel(r'$\frac{\lambda^2}{\mathrm{\mu m}^2}$')
plt.ylabel(r'$\theta \frac{\mathrm{rad}}{\mathrm{\mu m}}$')
plt.legend(loc="best")
plt.grid()
...
plt.plot(lam**2, theta_dot1, 'bx' , label= 'Messwerte', linewidth = 1)
plt.xlabel(r'$\frac{\lambda^2}{\mathrm{\mu m}^2}$')
plt.ylabel(r'$\theta \frac{\mathrm{rad}}{\mathrm{\mu m}}$')
plt.legend(loc="best")
plt.grid()
...
plt.plot(lam**2, theta_dot2, 'bx' , label= 'Messwerte', linewidth = 1)
plt.xlabel(r'$\frac{\lambda^2}{\mathrm{\mu m}^2}$')
plt.ylabel(r'$\theta \frac{\mathrm{rad}}{\mathrm{\mu m}}$')
plt.legend(loc="best")
plt.grid()
...
init_vals = [1]
params, errors = curve_fit(fitFunc, lam**2, theta_frei_1, p0=init_vals)

a_1 = ufloat(params[0], errors[0])
x_0 = np.linspace(0, 7)

plt.plot(lam**2, theta_frei_1, 'bx' , label= 'Messwerte', linewidth = 1)
...
init_vals = [1]
params, errors = curve_fit(fitFunc, lam**2, theta_frei_2, p0=init_vals)

a_2 = ufloat(params[0], errors[0])

plt.plot(lam**2, theta_frei_2, 'bx' , label= 'Messwerte', linewidth = 1)
plt.plot(x_0, params[0]*x_0, label='Ausgleichsgerade')
plt.xlabel(r'$\frac{\lambda^2}{\mathrm{\mu m}^2}$')
plt.ylabel(r'$\theta \frac{\mathrm{rad}}{\mathrm{\mu m}}$')
plt.legend(loc="best")
