...
\usepackage{bookmark}
\title{V18\\ Hochreine Germaniumdetektoren in der Gamma-Spektrometrie}
\author{
Miriam Simm\\
...
\date{Durchführung: - \\ Abgabe: 19.07.2020}
\usepackage{amsmath} 
\usepackage{amssymb} 
...
\captionsetup{format=plain, labelfont = bf, textfont = small}
